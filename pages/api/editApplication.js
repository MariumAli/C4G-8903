        ...
        let application_db_result = await executeQuery(
            {
                ...
                query: 'UPDATE Application_Applicant_LRO SET '
                        + 'DOB = ?, FirstName = ?, LastName = ?, MiddleName = ?, StreetAddress = ?, City = ?, PostalCode = ?, '
                         + 'Country = ?, LRONumber = ?, LROAgencyName = ?, LROEmail = ?, FundingPhase = ?, Jurisdiction = ?, '
                         + 'PaymentVendor = ?, MonthlyRentAmt = ?, MonthyRentAmt_LRO = ?, MonthlyMortgageAmt = ?, MonthlyMortgageAmt_LRO = ?, '
                         + 'LodgingCostPerNight = ?, LodgingNightCount = ?, LodgingCostPerNight_LRO = ?, MonthlyGasAmt = ?, '
                         + 'MonthlyGasAmt_LRO = ?, MonthlyElectricityAmt = ?, MonthlyElectricityAmt_LRO = ?, MonthlyWaterAmt = ?, '
                         + 'MonthlyWaterAmt_LRO = ?, RequestorEmail = ?, Status = ? '
                         + 'WHERE `Application_Applicant_LRO`.`ApplicationId` = ?'
                         ,
