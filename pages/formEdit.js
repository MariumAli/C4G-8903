                ...
                <div className={styles.container}><h1>Application Form</h1></div>
                {
                    formSuccess ?
                        ...
                        <form id="application-form" onSubmit={submitForm} style={{ overflow: 'hidden' }}>
                            ...
                            <button className={styles.button} style={{ marginTop: '10px', marginBottom: "10px" }} type="submit">Edit Information</button>
                            <button className={styles.button} style={{ marginTop: '10px', marginBottom: "10px" }} onClick={() => router.push('/')}>Cancel Edit and Return to Home Page</button>
                        </form>
                }
            </div >
